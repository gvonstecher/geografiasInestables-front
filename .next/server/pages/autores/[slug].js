...
/* harmony export */   "default": () => (/* reexport safe */ private_next_pages_autores_slug_js__WEBPACK_IMPORTED_MODULE_0__.ZP),
/* harmony export */   "getStaticPaths": () => (/* reexport safe */ private_next_pages_autores_slug_js__WEBPACK_IMPORTED_MODULE_0__.Fe),
/* harmony export */   "getStaticProps": () => (/* reexport safe */ private_next_pages_autores_slug_js__WEBPACK_IMPORTED_MODULE_0__.b1)
/* harmony export */ });
/* harmony import */ var private_next_pages_autores_slug_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7251);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_autores_slug_js__WEBPACK_IMPORTED_MODULE_0__]);
private_next_pages_autores_slug_js__WEBPACK_IMPORTED_MODULE_0__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
function Notas({ autor , notas , podcasts , backendUrl , onLoadPlayer  }) {
        ...
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_Layout__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z, {
            children: [
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                    className: "bg-white rounded-lg px-20 py-12 drop-shadow-md mb-8",
...
async function getStaticPaths() {
    const { data  } = await client.query({
        query: _graphql_queries__WEBPACK_IMPORTED_MODULE_5__/* .GET_AUTORS_SLUGS */ .zR
    });
...
async function getStaticProps({ params  }) {
    const { data  } = await client.query({
        query: _graphql_queries__WEBPACK_IMPORTED_MODULE_5__/* .GET_AUTOR_POSTS */ .m_,
        variables: {
            slug: params.slug
        }
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [893,636,402,345,838,130,833,947,618,661], () => (__webpack_exec__(2405)));

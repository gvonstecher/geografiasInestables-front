        ...
        <>
                            <article className='col-span-full bg-white dark:bg-black dark:text-white p-5 flex rounded-lg md:p-12 flex-col-reverse md:flex-row drop-shadow-md'>
								<div className='flex basis-3/5'>
									<div className='flex flex-col justify-between me-10 grow'>
										<div>
										{(typeof categoria != "undefined" && typeof categoria != null && categoria !=null ) &&
                                                <Link href={'/programas/'+categoria.attributes.slug}>
                                                    <h3 className='font-medium text-light-verde-claro mb-2 font-work uppercase'>{categoria.attributes.Titulo}</h3>
                                                </Link>
                                            }
											<Link href={'/podcasts/'+slug}>
												<h2 className='font-noto text-2xl mb-3 inline-block border-b border-gray-400 pb-3 mb-3 pe-5'>{titulo}</h2>
											</Link>
											<div className='my-3 text-lg font-work text-gray-700 dark:text-white'>

...
export default function NotaDestacada({ titulo, slug, categoria, descripcionCorta, cuerpo, imagenDestacada, backendUrl }) {
    return(
        <>
            <article className='col-span-full bg-white dark:bg-black dark:text-white rounded-lg p-5 flex drop-shadow-md flex-col-reverse md:flex-row md:p-12 md:pl-20'>
						...
						<div>
											{(typeof categoria != "undefined" && typeof categoria != null && categoria !=null ) &&
												<Link href={'/secciones/'+categoria.slug}>
													<h3 className='uppercas text-light-verde-claro font-medium mb-2 font-work'>{categoria.Titulo}</h3>
												</Link>
											}

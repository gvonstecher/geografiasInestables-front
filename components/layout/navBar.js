...
const NavBar = () => {
  ...
  return (
    <>
        <nav
            className="container relative  mx-auto flex items-center w-full z-10 justify-between lg:px-8"
            aria-label="Global"
        >
            ...
            <ul className="hidden lg:flex text-xl lg:gap-x-12">
                <li className="relative">
                    ...
                    <i className="px-2">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className=" inline-block dark:hidden" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_86_135" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                <rect width="24" height="24" fill="#D9D9D9" />
                            </mask>
                            <g mask="url(#mask0_86_135)">
                                <path fill="#1C1B1F" d="M4 18.5208C3.45 18.5208 2.97917 18.3319 2.5875 17.9541C2.19583 17.5763 2 17.1222 2 16.5917V5.01657H4V16.5917H19V18.5208H4ZM8 14.6625C7.45 14.6625 6.97917 14.4736 6.5875 14.0958C6.19583 13.718 6 13.2638 6 12.7333V1.1582H23V12.7333C23 13.2638 22.8042 13.718 22.4125 14.0958C22.0208 14.4736 21.55 14.6625 21 14.6625H8ZM8 12.7333H21V3.08738H8V12.7333ZM10 9.83952H14V5.01657H10V9.83952ZM15 9.83952H19V7.91034H15V9.83952ZM15 6.94575H19V5.01657H15V6.94575Z"/>
                            </g>
                        </svg>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="hidden dark:inline-block" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_86_135" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                <rect width="24" height="24" fill="#26A69A" />
                            </mask>
                            <g mask="url(#mask0_86_135)">
                                <path fill="#26A69A" d="M4 18.5208C3.45 18.5208 2.97917 18.3319 2.5875 17.9541C2.19583 17.5763 2 17.1222 2 16.5917V5.01657H4V16.5917H19V18.5208H4ZM8 14.6625C7.45 14.6625 6.97917 14.4736 6.5875 14.0958C6.19583 13.718 6 13.2638 6 12.7333V1.1582H23V12.7333C23 13.2638 22.8042 13.718 22.4125 14.0958C22.0208 14.4736 21.55 14.6625 21 14.6625H8ZM8 12.7333H21V3.08738H8V12.7333ZM10 9.83952H14V5.01657H10V9.83952ZM15 9.83952H19V7.91034H15V9.83952ZM15 6.94575H19V5.01657H15V6.94575Z"/>
                            </g>
                        </svg>
                    </i>
                    Notas
                    ...
                    className={
                        subNotasOpen
                        ? "absolute bg-light-gris dark:bg-dark-verde-oscuro top-[51px] block left-1 ease-in duration-200 z-50 w-max"
                        : "absolute bg-light-gris dark:bg-dark-verde-oscuro top-[51px] hidden left-1 ease-in duration-200 overflow-hidden w-max"
                    }
                    >
                        <ul className="grid grid-cols-1 gap-4 p-4 shadow-[inset_0_4px_4px_-0px_rgba(0,0,0,0.25)]">
                            {subNotasLinks.map((link) => (
                                <li key={link.id} className='bg-white text-black dark:bg-black dark:text-dark-verde-claro text-base w-full min-w-[250px] rounded-md shadow-[0_4px_4px_-0px_rgba(0,0,0,0.25)] hover:bg-gray-300'>
                                    
                                    <Link href={'/secciones/' + link.attributes.slug} className="flex w-full items-center p-2 py-3 text-left">
                        ...
                        >
                            <ul className="divide-gray-100 grid grid-cols-1 gap-4 p-4 shadow-[inset_0_4px_4px_-0px_rgba(0,0,0,0.25)]">
                                {subPodcastsLinks.map((link) => (
                                    <li key={link.id} className="bg-white text-black dark:bg-black dark:text-dark-verde-claro text-base w-full w-[250px] rounded-md shadow-[0_4px_4px_-0px_rgba(0,0,0,0.25)] hover:bg-gray-300">
                                        <Link href={'/programas/' + link.attributes.slug} className='flex w-full items-center text-left p-2'>
                                            <span className="h-10 w-10 bg-[#D9D9D9] rounded-full mr-3 shrink-0"></span>
                                            {link.attributes.Titulo}
                                        </Link>
                                    </li>
                                ))}
                ...
                <li>
                    <Link href="/musica" className="flex items-center">
                        <i className="px-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" className=" inline-block dark:hidden" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_33_288)">
                                    <path fill="#212134" opacity="0.3" d="M10.0098 19C11.1143 19 12.0098 18.1046 12.0098 17C12.0098 15.8954 11.1143 15 10.0098 15C8.9052 15 8.00977 15.8954 8.00977 17C8.00977 18.1046 8.9052 19 10.0098 19Z"/>
                                    <path fill="#212134" d="M12 3L12.01 13.55C11.42 13.21 10.74 13 10.01 13C7.79 13 6 14.79 6 17C6 19.21 7.79 21 10.01 21C12.23 21 14 19.21 14 17V7H18V3H12ZM10.01 19C8.91 19 8.01 18.1 8.01 17C8.01 15.9 8.91 15 10.01 15C11.11 15 12.01 15.9 12.01 17C12.01 18.1 11.11 19 10.01 19Z" />
                                </g>
                                <defs><clipPath id="clip0_33_288"><rect width="24" height="24" fill="white" /></clipPath></defs>
                            </svg>

                            <svg width="24" height="24" viewBox="0 0 24 24" className="hidden dark:inline-block" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_33_288)">
                                    <path fill="#26A69A" opacity="0.3" d="M10.0098 19C11.1143 19 12.0098 18.1046 12.0098 17C12.0098 15.8954 11.1143 15 10.0098 15C8.9052 15 8.00977 15.8954 8.00977 17C8.00977 18.1046 8.9052 19 10.0098 19Z"/>
                                    <path fill="#26A69A" d="M12 3L12.01 13.55C11.42 13.21 10.74 13 10.01 13C7.79 13 6 14.79 6 17C6 19.21 7.79 21 10.01 21C12.23 21 14 19.21 14 17V7H18V3H12ZM10.01 19C8.91 19 8.01 18.1 8.01 17C8.01 15.9 8.91 15 10.01 15C11.11 15 12.01 15.9 12.01 17C12.01 18.1 11.11 19 10.01 19Z" />
                                </g>
                                <defs><clipPath id="clip0_33_288"><rect width="24" height="24" fill="white" /></clipPath></defs>
                            </svg>
                        </i>
                ...
                <li>
                    <Link href="/busqueda" className="flex items-center">
                        <i className="px-2">
                            <svg viewBox="0 0 20 20" fill="#212134" className="h-5 w-5 inline-block dark:hidden" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg viewBox="0 0 20 20" fill="#26A69A" className="h-5 w-5 hidden dark:inline-block"  xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z"/>
                            </svg>
                        </i>
                        Buscar
                ...
                <ul>
                    <li className="my-3">
                        <Link href="/busqueda" className=" text-black group flex w-full items-center p-4 whitespace-nowrap hover:bg-gray-200 rounded-md shadow-[0_4px_4px_-0px_rgba(0,0,0,0.25)]">
                            <i className="px-2">
                                <svg viewBox="0 0 20 20" fill="currentColor" className="h-5 w-5" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z"/>
                                </svg>
                            </i>
                            Buscar
                            ...
                            <div className="flex">
                                <i className="px-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <mask id="mask0_86_135" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24"><rect width="24" height="24" fill="#D9D9D9" /></mask>
                                        <g mask="url(#mask0_86_135)"><path d="M4 18.5208C3.45 18.5208 2.97917 18.3319 2.5875 17.9541C2.19583 17.5763 2 17.1222 2 16.5917V5.01657H4V16.5917H19V18.5208H4ZM8 14.6625C7.45 14.6625 6.97917 14.4736 6.5875 14.0958C6.19583 13.718 6 13.2638 6 12.7333V1.1582H23V12.7333C23 13.2638 22.8042 13.718 22.4125 14.0958C22.0208 14.4736 21.55 14.6625 21 14.6625H8ZM8 12.7333H21V3.08738H8V12.7333ZM10 9.83952H14V5.01657H10V9.83952ZM15 9.83952H19V7.91034H15V9.83952ZM15 6.94575H19V5.01657H15V6.94575Z" fill="#1C1B1F"/></g>
                                    </svg>
                                </i>
                                Notas
                            </div>
                        ...
                        <Link href="/musica" className=" text-black group flex w-full items-center p-4 whitespace-nowrap rounded-md shadow-[0_4px_4px_-0px_rgba(0,0,0,0.25)] hover:bg-gray-200">
                            <i className="px-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_33_288)">
                                        <path fill="black" opacity="0.3" d="M10.0098 19C11.1143 19 12.0098 18.1046 12.0098 17C12.0098 15.8954 11.1143 15 10.0098 15C8.9052 15 8.00977 15.8954 8.00977 17C8.00977 18.1046 8.9052 19 10.0098 19Z"/>
                                        <path fill="black" d="M12 3L12.01 13.55C11.42 13.21 10.74 13 10.01 13C7.79 13 6 14.79 6 17C6 19.21 7.79 21 10.01 21C12.23 21 14 19.21 14 17V7H18V3H12ZM10.01 19C8.91 19 8.01 18.1 8.01 17C8.01 15.9 8.91 15 10.01 15C11.11 15 12.01 15.9 12.01 17C12.01 18.1 11.11 19 10.01 19Z"/>
                                    </g>
                                    <defs><clipPath id="clip0_33_288"><rect width="24" height="24" fill="white" /></clipPath></defs>
                                </svg>
                            </i>

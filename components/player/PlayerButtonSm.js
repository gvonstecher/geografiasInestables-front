...
const PlayerButtonSm = ({ duracion = null, onClick}) => {
  ...
  return (
    <>
        <button 
            className='bg-light-verde hover:bg-light-verde-oscuro dark:hover:bg-dark-verde-claro text-white font-noto rounded-full p-4 flex'
		...
		{typeof duracion != "object" &&
			<div className='mt-3 text-gray-800 dark:text-white text-sm'>
